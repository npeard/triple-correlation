...
def test_order_unpacking_equivalence():
    ...
    for i in range(batch_size):
        ...
        single_matrix = x[i]
        unpacked = AbsPhiDataset.unpack_by_orders(single_matrix)
    ...
    batched_method_results = GPTDecoder._unpack_by_orders_batched(x)
    ...
    single_dataset_result = AbsPhiDataset.unpack_by_orders(single_batch.squeeze())
    single_batched_result = GPTDecoder._unpack_by_orders_batched(single_batch)
...
if __name__ == "__main__":
    test_order_unpacking_equivalence()
